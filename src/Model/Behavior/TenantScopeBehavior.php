 ...
 */
	public function __construct(Table $table, array $config = []) {
		...
		$appTenantScopeBehaviorConfig = MTApp::config( 'ScopeBehavior' );
		if ( is_array($appTenantScopeBehaviorConfig ) AND  array_key_exists('foreign_key_field', $appTenantScopeBehaviorConfig ) ) {
			$this->config('foreign_key_field', $appTenantScopeBehaviorConfig['foreign_key_field'], false);
		} 
